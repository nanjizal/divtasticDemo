...
if(!samples.examples.color_picker) samples.examples.color_picker = {}
samples.examples.color_picker.ColorPicker = function(p) {
	if( p === $_ ) return;
	...
	new samples.examples.color_picker.application.Controller(_holder);
}
samples.examples.color_picker.ColorPicker.__name__ = ["samples","examples","color_picker","ColorPicker"];
samples.examples.color_picker.ColorPicker.main = function() {
	new samples.examples.color_picker.ColorPicker();
}
samples.examples.color_picker.ColorPicker.prototype.__class__ = samples.examples.color_picker.ColorPicker;
...
if(!samples.examples.color_picker.views) samples.examples.color_picker.views = {}
samples.examples.color_picker.views.HexagonPickerView = function(holder_,win_,firstColor,secondColor,selectColor) {
	if( holder_ === $_ ) return;
	this._enabled = true;
	this._holder = holder_;
	this._win = win_;
	this._selectColor = selectColor;
	this._gradFiller = new divtastic.js.GradientFiller(null);
	var arrHex = new divtastic.js.application.views.ColorHexagon(holder_,50,85,15,12,firstColor,secondColor,zpartanlite.Orientation.Horizontal);
	var _g1 = 0, _g = arrHex.hexagons.length;
	while(_g1 < _g) {
		var i = _g1++;
		var colHex = arrHex.hexagons[i];
		colHex.div.over.add((function(f,a1) {
			return function() {
				return f(a1);
			};
		})($closure(this,"hexSelected"),colHex));
		colHex.div.out.add((function(f,a1) {
			return function() {
				return f(a1);
			};
		})($closure(this,"hexOut"),colHex));
		colHex.div.press.add($closure(this,"toggleEnable"));
		colHex.div.getStyle().cursor = "pointer";
	}
}
samples.examples.color_picker.views.HexagonPickerView.__name__ = ["samples","examples","color_picker","views","HexagonPickerView"];
samples.examples.color_picker.views.HexagonPickerView.prototype._holder = null;
samples.examples.color_picker.views.HexagonPickerView.prototype._win = null;
samples.examples.color_picker.views.HexagonPickerView.prototype._enabled = null;
samples.examples.color_picker.views.HexagonPickerView.prototype._gradFiller = null;
samples.examples.color_picker.views.HexagonPickerView.prototype._selectColor = null;
samples.examples.color_picker.views.HexagonPickerView.prototype.toggleEnable = function() {
	this._enabled = !this._enabled;
}
samples.examples.color_picker.views.HexagonPickerView.prototype.hexSelected = function(colHex) {
	if(this._enabled) {
		this._win.set_fill(colHex.firstColor);
		this._gradFiller.setGrads(colHex.hexGrad);
		this._gradFiller.fill(this._selectColor);
	}
}
samples.examples.color_picker.views.HexagonPickerView.prototype.hexOut = function(colHex) {
	this._gradFiller.setGrads(colHex.hexGrad);
	this._gradFiller.fill(colHex.secondColor,colHex.firstColor);
}
samples.examples.color_picker.views.HexagonPickerView.prototype.__class__ = samples.examples.color_picker.views.HexagonPickerView;
...
divtastic.js.application.views.ColorPallet = { __ename__ : ["divtastic","js","application","views","ColorPallet"], __constructs__ : ["Light","Dark"] }
divtastic.js.application.views.ColorPallet.Light = ["Light",0];
divtastic.js.application.views.ColorPallet.Light.toString = $estr;
divtastic.js.application.views.ColorPallet.Light.__enum__ = divtastic.js.application.views.ColorPallet;
divtastic.js.application.views.ColorPallet.Dark = ["Dark",1];
divtastic.js.application.views.ColorPallet.Dark.toString = $estr;
divtastic.js.application.views.ColorPallet.Dark.__enum__ = divtastic.js.application.views.ColorPallet;
divtastic.js.application.views.ColorHexagon = function(holder_,offX,offY,hexWidth,hexHeight,first_,second_,orientation) {
	if( holder_ === $_ ) return;
	switch( (first_)[1] ) {
	case 0:
		this._firstColor = 1;
	...
	this._holder = holder_;
	var colors = [[[16711935,16711935],[13369599,13369599],[10027263,6684927],[6684927,6684927],[3342591,3342591],[255,255]],[[16711884,16711884],[13369548,16724991],[10027212,13382655],[6684876,10040319],[3342540,6697983],[204,3355647],[13311,13311]],[[16711833,16711833],[13369497,16724940],[10027161,16738047],[6684825,13395711],[3342489,10053375],[153,6711039],[13260,3368703],[26367,26367]],[[16711782,16711782],[13369446,16724889],[10027110,16737996],[6684825,16751103],[3342438,13408767],[102,10066431],[13209,6724095],[26316,3381759],[39423,39423]],[[16711731,16711731],[13369395,16724838],[10027059,16737945],[6684723,16751052],[3342387,16764159],[51,13421823],[13158,10079487],[26265,6737151],[39372,3394815],[52479,52479]],[[16711680,16711680],[13369344,16724787],[10027008,16737894],[6684672,16751001],[3342336,16764108],[0,16777215],[13107,13434879],[26214,10092543],[39321,6750207],[52428,3407871],[65535,65535]],[[16724736,16724736],[13382400,16737843],[10040064,16750950],[6697728,16764057],[3355392,16777164],[13056,13434828],[26163,10092492],[39270,6750156],[52377,3407820],[65484,65484]],[[16737792,16737792],[13395456,16750899],[10053120,16764006],[6710784,16777113],[3368448,13434777],[26112,10092441],[39219,6750105],[52326,3407769],[65433,65433]],[[16750848,16750848],[13408512,16763955],[10066176,16777062],[6723840,13434726],[3381504,10092390],[39168,6750054],[52275,3407769],[65382,65382]],[[16763904,16763904],[13421568,16777011],[10079232,13434675],[6736896,10092339],[3394560,6750003],[52224,3407667],[65331,65331]],[[16776960,16776960],[13434624,13434624],[10092288,10092288],[6749952,6749952],[3407616,3407616],[65280,65280]]];
	var stepX = hexWidth;
	var stepY = hexHeight;
	var initX = offX;
	var initY = offY;
	...
	while(_g < 6) {
		var i = _g++;
		var _g2 = 0, _g1 = colors[i].length;
		while(_g2 < _g1) {
			var j = _g2++;
			hex = new divtastic.js.Divtastic();
			this._holder.addChild(hex);
			hex.set_width(Std["int"](stepX));
			hex.set_height(Std["int"](stepY));
			hex.set_x(initX);
			hex.set_y(initY);
			hexGrad = divtastic.js.Drawing.drawGradHexagon(hex,0,0,Std["int"](stepX),Std["int"](stepY),colors[i][j][this._firstColor],colors[i][j][this._secondColor],1,orientation);
			initY += stepY;
			this.hexagons.push({ div : hex, firstColor : colors[i][j][this._firstColor], secondColor : colors[i][j][this._secondColor], xStart : hex.get_x(), yStart : hex.get_y(), hexGrad : hexGrad});
		}
...
divtastic.js.application.views.ColorHexagon.__name__ = ["divtastic","js","application","views","ColorHexagon"];
divtastic.js.application.views.ColorHexagon.prototype._holder = null;
divtastic.js.application.views.ColorHexagon.prototype._firstColor = null;
divtastic.js.application.views.ColorHexagon.prototype._secondColor = null;
divtastic.js.application.views.ColorHexagon.prototype.hexagons = null;
divtastic.js.application.views.ColorHexagon.prototype.__class__ = divtastic.js.application.views.ColorHexagon;
...
if(!samples.examples.color_picker.application) samples.examples.color_picker.application = {}
samples.examples.color_picker.application.Controller = function(holder_) {
	if( holder_ === $_ ) return;
	this._holder = holder_;
	var pickerWindowLight = new divtastic.js.Divtastic();
	this._holder.addChild(pickerWindowLight);
	var windowViewLight = new divtastic.js.application.views.WindowView(pickerWindowLight,"Light Color Picker",0,50,220,220,"#9d9e6a");
	new samples.examples.color_picker.views.HexagonPickerView(pickerWindowLight,windowViewLight,divtastic.js.application.views.ColorPallet.Light,divtastic.js.application.views.ColorPallet.Light,0);
	var pickerWindowDark = new divtastic.js.Divtastic();
	this._holder.addChild(pickerWindowDark);
	var windowViewDark = new divtastic.js.application.views.WindowView(pickerWindowDark,"Dark Color Picker",300,50,220,220,"#9d9e6a");
	new samples.examples.color_picker.views.HexagonPickerView(pickerWindowDark,windowViewDark,divtastic.js.application.views.ColorPallet.Dark,divtastic.js.application.views.ColorPallet.Dark,16777215);
	var pickerWindowBoth = new divtastic.js.Divtastic();
	this._holder.addChild(pickerWindowBoth);
	var windowViewBoth = new divtastic.js.application.views.WindowView(pickerWindowBoth,"Color Picker",150,310,220,220,"#9d9e6a");
	new samples.examples.color_picker.views.HexagonPickerView(pickerWindowBoth,windowViewBoth,divtastic.js.application.views.ColorPallet.Dark,divtastic.js.application.views.ColorPallet.Light,13421772);
}
samples.examples.color_picker.application.Controller.__name__ = ["samples","examples","color_picker","application","Controller"];
samples.examples.color_picker.application.Controller.prototype._holder = null;
samples.examples.color_picker.application.Controller.prototype.__class__ = samples.examples.color_picker.application.Controller;
$_ = {}
js.Boot.__res = {}
js.Boot.__init();
{
...
samples.examples.color_picker.ColorPicker.main()