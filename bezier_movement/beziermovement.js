...
if(!samples.examples.bezier_movement) samples.examples.bezier_movement = {}
samples.examples.bezier_movement.BezierMovement = function(p) {
	if( p === $_ ) return;
	...
	new samples.examples.bezier_movement.application.Controller(_holder);
}
samples.examples.bezier_movement.BezierMovement.__name__ = ["samples","examples","bezier_movement","BezierMovement"];
samples.examples.bezier_movement.BezierMovement.main = function() {
	new samples.examples.bezier_movement.BezierMovement();
}
samples.examples.bezier_movement.BezierMovement.prototype.__class__ = samples.examples.bezier_movement.BezierMovement;
if(!samples.examples.bezier_movement.application) samples.examples.bezier_movement.application = {}
samples.examples.bezier_movement.application.Controller = function(holder_) {
	if( holder_ === $_ ) return;
...
samples.examples.bezier_movement.application.Controller.__name__ = ["samples","examples","bezier_movement","application","Controller"];
samples.examples.bezier_movement.application.Controller.prototype._holder = null;
samples.examples.bezier_movement.application.Controller.prototype.circleRed = null;
samples.examples.bezier_movement.application.Controller.prototype.circleGreen = null;
samples.examples.bezier_movement.application.Controller.prototype.circleBlue = null;
samples.examples.bezier_movement.application.Controller.prototype.circleYellow = null;
samples.examples.bezier_movement.application.Controller.prototype.createCircle = function(x,y,col) {
...
samples.examples.bezier_movement.application.Controller.prototype.createRightArrow = function(aTab) {
...
samples.examples.bezier_movement.application.Controller.prototype.move = function() {
	var me = this;
	...
	t.setTweenHandlers(function(e) {
		me.circleYellow.set_x(divtastic.Movement.quadraticBezierThru(e,me.circleRed.get_x(),me.circleGreen.get_x(),me.circleBlue.get_x()));
		me.circleYellow.set_y(divtastic.Movement.quadraticBezierThru(e,me.circleRed.get_y(),me.circleGreen.get_y(),me.circleBlue.get_y()));
	},function(e) {
		me.circleYellow.set_visible(false);
	});
	t.start();
}
samples.examples.bezier_movement.application.Controller.prototype.__class__ = samples.examples.bezier_movement.application.Controller;
...
samples.examples.bezier_movement.application.Controller.red = 16711680;
samples.examples.bezier_movement.application.Controller.green = 65280;
samples.examples.bezier_movement.application.Controller.blue = 255;
samples.examples.bezier_movement.application.Controller.yellow = 16776960;
samples.examples.bezier_movement.application.Controller.diaX = 18;
samples.examples.bezier_movement.application.Controller.diaY = 20;
samples.examples.bezier_movement.application.Controller.velocity = 2500;
divtastic.js.application.views.WindowView.headerHeight = 20;
js.Lib.onerror = null;
divtastic.js.GlobalDiv._root = js.Lib.document;
samples.examples.bezier_movement.BezierMovement.main()